...
class DeleteFolderHandler final : public userver::server::handlers::HttpHandlerBase {
public:
    static constexpr std::string_view kName = "handler-folders-delete";

    DeleteFolderHandler(const userver::components::ComponentConfig& config,
